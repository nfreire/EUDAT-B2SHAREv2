...
import eudat.auth.Authentication;
import eudat.auth.HttpBasicAuth;
import eudat.auth.ApiKeyAuth;
import eudat.auth.OAuth;


public class ApiClient {
  private Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  private String basePath = "https://trng-b2share.eudat.eu/api";
  ...
  public ApiClient() {
    ...
    setUserAgent("Swagger-Codegen/0.1/java");
